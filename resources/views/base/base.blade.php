...
<html lang="ar"
      {!! theme()->printHtmlAttributes('html') !!} {{ theme()->printHtmlClasses('html') }} dir="rtl">
{{-- begin::Head --}}
<head>
    <meta charset="utf-8"/>
...
{{-- begin::Body --}}
<body
    class="print-content-only" {!! theme()->printHtmlAttributes('body') !!} {!! theme()->printHtmlClasses('body') !!} {!! theme()->printCssVariables('body') !!}>
