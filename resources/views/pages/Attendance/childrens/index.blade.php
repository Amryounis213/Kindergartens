        ...
        <div class="card">
            ...
            <div class="card-header border-1 pt-6">
                ...
                <div class="card-title ">
                    ...
                    <div class="d-flex align-items-center position-relative my-1 m-3">
                        <!--begin::Svg Icon | path: icons/duotune/general/gen021.svg-->
                        <form action="{{route('DivisionFilterSearch' )}}" method="POST">
                        @csrf
                        @method('post')
                        <select onchange="this.form.submit()" name="division_id" aria-label="{{ __('Select') }} الشعبة" id="clinic_id"
                            data-control="select2" data-placeholder="{{ __('Select') }} الشعبة .."
                            class="form-select form-select-solid form-select-md fw-bold w-250px ps-15 ml-5"
                            
                            >
                            <option value="-1">{{ __('Select') }}الشعبة...
                            </option>
            ...
            <!--end::Card header-->
            <!--begin::Card body-->
            <form action="{{ route('cattendance.store') }}" method="POST">
                @csrf
                <div class="card-body pt-6">
                    @include('pages.Attendance.childrens.parts._table')
                </div>
