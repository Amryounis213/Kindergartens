                    ...
                    <div class="card-body py-20">
                        ...
                        <div class="mw-lg-950px mx-auto w-100">
                            ...
                            <div class="d-flex justify-content-between  flex-sm-row mb-12">
                                <div>
                                    <h4 class="fw-boldest text-gray-800 fs-2qx pe-5 pb-7">تقرير الطبيب</h4>
                                    ...
                                    <div class="fs-6 fw-bold mb-3">
                                        ...
                                        <span class="text-gray-800">{{$order->patient->address}}</span>
                                    </div>
                                    ...
                                    <div class="flex-grow-1 pt-8 mb-6">
                                                ...
                                                @if(sizeof($order->diagnostics) > 0)
                                                    @foreach($order->diagnostics as $item)
                                                        <tr class="fw-bolder text-gray-700 fs-5">
                                                            ...
                                                            <td class="pt-5" colspan="3">{{$item->diagnosis->description}}</td>
                                                        </tr>
                                                    @endforeach
                                                @endif
                                                ...
                                                @if(sizeof($order->checkups) > 0  && $order->lab_payment == -1)
                                                    @foreach($order->checkups as $item)
                                                        <tr class="fw-bolder text-gray-700 fs-5">
                                                            ...
                                                            <td class="pt-5" colspan="2">{{$item->instructions}}</td>
                                                        </tr>
                                                    @endforeach
                                                @endif
                                        ...
                                        <div class="d-flex flex-column mw-md-300px w-100">
                                            ...
                                            <div class="d-flex flex-stack text-gray-800 mb-3 fs-6">
                                                ...
                                                <!--end::Accountname-->
                                                <!--begin::Label-->
                                                <div class="text-end fw-norma"> {{$order->clinic->name}}</div>
                                                <!--end::Label-->
                                            </div>
                                            <!--end::Item-->
                                            <!--begin::Item-->
                                            <div class="d-flex flex-stack text-gray-800 mb-3 fs-6">
                                                ...
                                                <!--end::Accountnumber-->
                                                <!--begin::Number-->
                                                <div class="text-end fw-norma">{{auth()->user()->name}}</div>
                                                <!--end::Number-->
                                            </div>
                                            <!--end::Item-->
                                        </div>
                            ...
                            <div class="d-flex  justify-content-end flex-wrap mt-lg-6">
                                <a type="button" class="btn btn-secondary m-1 w-100px"
                                   href="{{ route('order.doctor', $order) }}">رجــــوع</a>
