            ...
            <div class="card mb-5 mb-xl-10">
                ...
                <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
                    ...
                    <div class="card-title m-0">
                        <h3 class="fw-bolder m-0">تسكين سائق </h3>
                    </div>
                    <!--end::Card title-->
                </div>
                <!--begin::Card header-->
                ...
                <div id="kt_account_profile_details" class="collapse show">
                    ...
                    <div class="card-body border-top p-9 item">
                        <form id="details_form" class="form" method="POST"
                            action="{{ route('driverplacment.store') }}" enctype="multipart/form-data">
                            @csrf
                            @method('POST')
                            <!--begin::Input group-->
                            <div class="card-body border-top p-9">
                                ...
                                <div class="row mb-6 fv-plugins-icon-container">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" name="itinerary" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0 name" placeholder="اسم الشعبة" value="">
