                                        ...
                                        <div class="col-lg-4">
                                            <div class="position-relative d-flex align-items-center">
                                                ...
                                                <input class="form-control form-control-solid ps-12 flatpickr-input dob"
                                                       placeholder="{{ __('Select a date')}}" name="bth_date" type="text" value="{{ old('dob') }}"
                                                       readonly="readonly">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row mb-6">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <input type="text" name="email" class="form-control form-control-lg form-control-solid mobile" placeholder="البريد" value="">
