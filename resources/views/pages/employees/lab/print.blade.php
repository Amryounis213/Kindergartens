                    ...
                    <div class="card-body py-20">
                        ...
                        <div class="mw-lg-950px mx-auto w-100">
                            ...
                            <div class="d-flex justify-content-between flex-column flex-sm-row">
                                <div>
                                    <h4 class="fw-boldest text-gray-800 fs-2x pe-5">تحاليل طبية</h4>
                                        ...
                                        <div class="table-responsive border-bottom mb-8">
                                            <table class="table">
                                                ...
                                                <tr class="border-bottom fs-6 fw-bolder text-muted text-uppercase">
                                                    <th class="min-w-70px pb-3">التحليل</th>
                                                    <th class="min-w-175px pb-3">الإرشادات</th>
                                                </tr>
                                                </thead>
                                                <tbody>
                                                @if($type == 'all')
                                                    @include('pages.order.lab._print_all')
                                                @elseif($type == 'in')
                                                    @include('pages.order.lab._print_in')
                                                @elseif($type == 'out')
                                                    @include('pages.order.lab._print_out')
                                                @endif
                                                </tbody>
                                            </table>
                                        </div>
                            ...
                            <div class="d-flex  justify-content-end flex-wrap mt-lg-6 pt-13">
                                <a type="button" class="btn btn-secondary m-1 w-100px"
                                   href="{{ route('order.lab', $order->id) }}">رجــــوع</a>
