    ...
    <div id="kt_content" class="content d-flex flex-column flex-column-fluid">
        <div class="card card-custom mb-3">
            ...
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0 b-1">  تعديل دفعة مصروف  </h3>
            </div>
            <!--end::Card title-->
        </div>
        <!--begin::Card header-->
            <div class="card-body">
                <!--begin: Search Form-->
                <form class="mb-5" action="{{route('expenses-pay.update' ,$expense->id)}}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="row mb-6">
                        <div class="col-lg-3 mb-lg-0 mb-6">
                            ...
                            <select id="expense_id" name="expense_id" class="form-control datatable-input"
                                ...
                                @foreach ($expenses as $exp)
                                    <option value="{{ $exp->id }}" {{$exp->id == $expense->id ? 'selected' : ''}}>{{ $exp->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="col-lg-3 mb-lg-0 mb-6">
                            ...
                            <input name="rec_name"  value="{{$expense->rec_name}}" type="text" class="form-control datatable-input"
                        ...
                        <div class="col-lg-3 mb-lg-0 mb-6">
                            ...
                            <select id="year" name="year" class="form-control datatable-input" data-col-index="2">
                                ...
                                <option value="{{$year->id}}" {{$year->id == $expense->year ? 'selected' : ''}}>{{$year->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row mb-6">
                        <div class="col-lg-2 mb-lg-0 mb-6">
                            ...
                            <input id="payment_amount2" name="payment_amount" type="text"
                                class="form-control datatable-input" placeholder="المبلغ المدفوع" data-col-index="4" value="{{$expense->payment_amount}}">
                        </div>
                        <div class="col-lg-2 mb-lg-0 mb-6">
                        ...
                        <div class="col-lg-2 mb-lg-0 mb-6">
                            ...
                            <input name="Receipt_number" id="Receipt_number" type="text"
                                class="form-control datatable-input" placeholder="" value="{{$expense->Receipt_number}}" data-col-index="4">
                        </div>
                        <div class="col-lg-3 mb-lg-0 mb-6">
                            <label>ملاحظات :</label>
                            <input name="notices" id="notices" type="text" class="form-control datatable-input"
                                placeholder="" data-col-index="4" value="{{$expense->notices}}">
                        </div>
                        <div class="col-lg-3 mb-lg-0 mb-6">
