        ...
        <div class="card mb-5 mb-xl-10">
            ...
            <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
                ...
                <div class="card-title m-0">
                    <h3 class="fw-bolder m-0">تعديل المصروف | {{$expense->name}}</h3>
                </div>
                <!--end::Card title-->
            </div>
            <!--begin::Card header-->
            ...
            <div id="kt_account_profile_details" class="collapse show">
                <!--begin::Form-->
                <form id="details_form" class="form"  action="{{ route('expenses.update' , $expense->id) }}" method="POST"
                ...
                <!--begin::Card body-->
                    <div class="card-body border-top p-9">
                        ...
                        <!--begin::Input group-->
                        <div class="row mb-6">
                            <label class="col-lg-4 col-form-label required fw-bold fs-6">اسم المصروف</label>
                            <div class="col-lg-8">
                                <input type="text" name="name"
                                       class="form-control form-control-lg form-control-solid mb-3 mb-lg-0 name"
                                       placeholder="اسم الايراد" value="{{ $expense->name }}"/>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-2 d-flex align-items-center">
                                <div class="form-check form-check-solid form-switch fv-row">
                                    ...
                                    <input class="form-check-input w-45px h-30px" type="checkbox" id="status"
                                           name="status" value="1" @if($expense->status) checked @else ' ' @endif />
