        ...
        <div class="card mb-5 mb-xl-10">
            ...
            <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
                ...
                <div class="card-title m-0">
                    <h3 class="fw-bolder m-0">اضافة ولي امر</h3>
                </div>
                <!--end::Card title-->
            </div>
            <!--begin::Card header-->
            ...
            <div id="kt_account_profile_details" class="collapse show">
                <!--begin::Form-->
                <form id="details_form" class="form" method="POST" action="{{ route('fathers.store') }}"
                    ...
                    <div class="card-body border-top p-9">
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8">
                                <input type="text" name="name"
                                       ...
                                       placeholder="اسم ولي الأمر" value="{{ old('name') }}"/>
                            </div>
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="row mb-6 fv-plugins-icon-container">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="mobile" class="form-control form-control-lg form-control-solid mobile  is-valid" placeholder="رقم المحمول" value="{{ old('mobile') }}">
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8">
                                <input type="text" name="address" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0 address" placeholder="العنوان"  value="{{ old('address') }}">
                            </div>
                        </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8">
                                <input type="text" name="occupation" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0 address" placeholder="المهنة" value="">
                            </div>
                        </div>
