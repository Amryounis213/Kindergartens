        ...
        <div class="card mb-5 mb-xl-10">
            ...
            <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
                ...
                <div class="card-title m-0">
                    <h3 class="fw-bolder m-0">انشاء ايراد جديد</h3>
                </div>
                <!--end::Card title-->
            </div>
            <!--begin::Card header-->
            ...
            <div id="kt_account_profile_details" class="collapse show">
                <!--begin::Form-->
                <form id="details_form" class="form" method="POST" action="{{ route('incomes.store') }}"
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8">
                                <input type="text" name="name"
                                       ...
                                       placeholder="اسم الايراد" value="{{ old('name') }}"/>
                            </div>
                        </div>
