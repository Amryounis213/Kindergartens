    ...
    <div id="kt_content" class="content d-flex flex-column flex-column-fluid">
        ...
        <div class="card mb-5 mb-xl-10">
            ...
            <div id="kt_account_profile_details" class="collapse show">
                <!--begin::Form-->
                <form id="details_form" class="form" method="POST" action="{{ route('incomesiwithchild.store') }}"
                        ...
                        <div class="col-lg-4">
                            ...
                            >
                                ...
                                @foreach($incomes as $item)
                                    <option
                                        value="{{$item->id}}" {{ $item->id == old('income_id') ? 'selected' :'' }}> {{$item->name}}  </option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="col-lg-12">
                            ...
                            >
                                ...
                                @foreach($years as $item)
                                    <option
                                        value="{{$item->id}}" {{ $item->id == old('year') ? 'selected' :'' }}> {{$item->name}}  </option>
                                @endforeach
                            </select>
                                </div>
