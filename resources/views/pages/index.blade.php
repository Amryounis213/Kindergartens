                    ...
                    <div class="card bgi-no-repeat card-xl-stretch mb-xl-5">
                        ...
                        <div class="card-body my-3">
                            <div class="d-flex">
                                ...
                                <a href="#" class="card-title fw-bolder text-success fs-5 mb-3 d-block">نسبة حضور
                                    الموظفين</a>
                            </div>
                            <div class="py-1">
                    ...
                    <div class="card bgi-no-repeat card-xl-stretch mb-xl-2">
                        ...
                        <div class="card-body my-3">
                            <div class="d-flex">
                                ...
                                <a href="#" class="card-title fw-bolder text-primary fs-5 mb-3 d-block">نسبة حضور
                                    الطلاب</a>
                            </div>
                            <div class="py-1">
                                <span class="text-dark fs-1 fw-bolder me-2"  data-kt-countup="true"
                    ...
                    <div class="card-body pt-5">
                        ...
                        <div class="timeline-label">
                            ...
                            <div class="timeline-item">
                                ...
                                <!--end::Badge-->
                                <!--begin::Desc-->
                                <div class="timeline-content fw-bolder text-gray-800 ps-3">&nbsp; استحقاق مالي على محمود
                                    محمد
                                    to ESL</div>
                                <!--end::Desc-->
                            </div>
                            ...
                            <div class="timeline-item">
                                ...
                                <!--end::Badge-->
                                <!--begin::Text-->
                                <div class="timeline-content fw-mormal text-muted ps-3">&nbsp; استحقاق مالي على سامر
                                </div>
                                <!--end::Text-->
                            </div>
                            <!--end::Item-->
                            ...
                            <div class="timeline-item">
                                ...
                                <!--end::Badge-->
                                <!--begin::Text-->
                                <div class="timeline-content fw-mormal text-muted ps-3">&nbsp; استحقاق مالي على عمرو
                                </div>
                                <!--end::Text-->
                            </div>
                            <!--end::Item-->
                            ...
                            <div class="timeline-item">
                                ...
                                <!--end::Badge-->
                                <!--begin::Desc-->
                                <div class="timeline-content fw-bold text-gray-800 ps-3">&nbsp; استحقاق مالي على محمد
                                    احمد احمد
                                    <a href="#" class="text-primary">#XF-2356</a>.
                                </div>
                                <!--end::Desc-->
                ...
                <div class="col-md-12 row">
                    <div class="col-xl-6">
                        <div class="card boxing bgi-no-repeat card-xl-stretch mb-5 mb-xl-8"
                            ...
                            <!--begin::Body-->
                            <div class="card-body">
                                <a href="#" class="card-title text-dark fw-bolder  text-hover-primary fs-4">السائقين</a>
                    ...
                    <div class="col-xl-6">
                        <div class="card boxing bgi-no-repeat card-xl-stretch mb-5 mb-xl-8"
                            ...
                            <!--begin::Body-->
                            <div class="card-body">
                                <a href="#" class="card-title text-dark fw-bolder  text-hover-primary fs-4">الروضات</a>
                                <div class="fw-bolder text-dark fs-3qx" data-kt-countup="true"
                ...
                <div class="col-md-12 row">
                    <div class="col-xl-6">
                        <div class="card bgi-no-repeat card-xl-stretch mb-5 mb-xl-8"
                            ...
                            <!--begin::Body-->
                            <div class="card-body">
                                <a href="#" class="card-title fw-bolder text-muted text-hover-primary fs-4">طلاب
                                    مسكنين</a>
                                <div class="fw-bolder text-primary fs-3qx" data-kt-countup="true"
