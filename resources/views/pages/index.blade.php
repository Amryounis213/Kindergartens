            ...
            <div class="col-xl-4">
               ...
               <div class="col-md-12">
                <div class="card bgi-no-repeat card-xl-stretch mb-xl-5">
                    ...
                    <div class="card-body my-3">
                        <div class="d-flex">
                            <span class="svg-icon svg-icon-success svg-icon-2x"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\legacy\metronic\theme\html\demo1\dist/../src/media/svg/icons\Shopping\Chart-bar1.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            ...
                            <a href="#" class="card-title fw-bolder text-success fs-5 mb-3 d-block">نسبة حضور الموظفين</a>
                        </div>
                        <div class="py-1">
                            <span class="text-dark fs-1 fw-bolder me-2"> {{ $per1 }}%</span>
                            <span class="fw-bold text-muted fs-7">نسبة</span>
                        </div>
                        <div class="progress h-7px bg-success bg-opacity-50 mt-7">
                            <div class="progress-bar bg-success" role="progressbar" style="width: {{$per1}}%" aria-valuenow="{{$per1}}" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <div class="card-footer">

                            <strong> الحضور / الكل :</strong>
                            <span>{{$employeeAtt}} من اصل {{$employeeCount}}</span>
                        </div>
               ...
               <div class="col-md-12">
                <div class="card bgi-no-repeat card-xl-stretch mb-xl-2">
                    ...
                    <div class="card-body my-3">
                        <div class="d-flex">
                            <span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\legacy\metronic\theme\html\demo1\dist/../src/media/svg/icons\Shopping\Chart-bar1.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"/>
                                    <rect fill="#000000" opacity="0.3" x="12" y="4" width="3" height="13" rx="1.5"/>
                                    <rect fill="#000000" opacity="0.3" x="7" y="9" width="3" height="8" rx="1.5"/>
                            ...
                            <a href="#" class="card-title fw-bolder text-primary fs-5 mb-3 d-block">نسبة حضور الطلاب</a>
                        </div>
                        <div class="py-1">
                            <span class="text-dark fs-1 fw-bolder me-2">{{$per2}}%</span>
                            <span class="fw-bold text-muted fs-7">نسبة</span>
                        </div>
                        <div class="progress h-7px bg-primary bg-opacity-50 mt-7">
                            <div class="progress-bar bg-primary" role="progressbar" style="width: {{$per2}}%" aria-valuenow="{{$per2}}" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <div class="card-footer">
                            <strong> الحضور / الكل :</strong>
                ...
                <div class="card card-xl-stretch mb-xl-8 bgi-no-repeat"
                    ...
                    <div class="card-header border-0 py-5">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bolder fs-3 mb-1">نسبة حضور الموظفين</span>
                        </h3>
                    ...
                    <div class="card-body d-flex flex-column">
                        <div class="flex-grow-1">
                            <div class="mixed-widget-4-chart" data-kt-chart-color="primary" style="height: 180px"></div>
                        </div>
                        <div class="pt-5">
                            <div class="mt-n12 position-relative zindex-0">
                                ...
                                <div class="d-flex align-items-center mb-8">
                                    ...
                                    <div>
                                        <a href="#"
                                            class="font-size-h6 text-dark-75 text-hover-primary font-weight-bolder">الحاضرين
                                            / الكل</a>
                                        <div class="font-size-sm text-muted font-weight-bold mt-1"> <span
                                                class="text-dark">15</span> /<span class="text-success">3</span>
                                        </div>
                                    </div>
                                    <!--end::Title-->
                                </div>
            ...
            <div class="col-xl-4">
                <div class="card mb-5 mb-xxl-8">
                    ...
                    <div class="card-header align-items-center border-0 mt-4">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="fw-bolder mb-2 text-dark">الأقساط المستحقة</span>
                    ...
                    <div class="card-body pt-5">
                        ...
                        <div class="timeline-label">
                            ...
                            <div class="timeline-item ">
                                ...
                                <!--end::Badge-->
                                <!--begin::Text-->
                                <div class="fw-mormal timeline-content  ps-3 "> &nbsp; استحقاق مالي على عمرو  </div>
                                <!--end::Text-->
                            </div>
                            <!--end::Item-->
                            <!--begin::Item-->
                            <div class="timeline-item">
                                ...
                                <div class="timeline-content d-flex">
                                    <span class="fw-bolder text-gray-800 ps-3">&nbsp; استحقاق مالي على احمد احمد </span>
                                </div>
                                <!--end::Content-->
                            </div>
                            <!--end::Item-->
                            ...
                            <div class="timeline-item">
                                ...
                                <!--end::Badge-->
                                <!--begin::Desc-->
                                <div class="timeline-content fw-bolder text-gray-800 ps-3">&nbsp; استحقاق مالي على محمود محمد 
                                 to ESL</div>
                                <!--end::Desc-->
                            </div>
                            <!--end::Item-->
                            ...
                            <div class="timeline-item">
                                ...
                                <!--end::Badge-->
                                <!--begin::Text-->
                                <div class="timeline-content fw-mormal text-muted ps-3">&nbsp; استحقاق مالي على سامر </div>
                                <!--end::Text-->
                            </div>
                            <!--end::Item-->
                            <!--begin::Item-->
                            ...
                            <div class="timeline-item">
                                <!--begin::Label-->
                                <div class="timeline-label fw-bolder text-gray-800 fs-6">400 ₪</div>
                                <!--end::Label-->
                                <!--begin::Badge-->
                                <div class="timeline-badge">
                                    <i class="fa fa-genderless text-primary fs-1"></i>
                                ...
                                <!--end::Badge-->
                                <!--begin::Text-->
                                <div class="timeline-content fw-mormal text-muted ps-3">&nbsp; استحقاق مالي على عمرو </div>
                                <!--end::Text-->
                            </div>
                            <!--end::Item-->
                            <!--begin::Item-->
                            <div class="timeline-item">
                                ...
                                <!--end::Badge-->
                                <!--begin::Desc-->
                                <div class="timeline-content fw-bold text-gray-800 ps-3">&nbsp; استحقاق مالي على محمد احمد احمد 
                                <a href="#" class="text-primary">#XF-2356</a>.</div>
                                <!--end::Desc-->
                            </div>
                            <!--end::Item-->
                            ...
                            <div class="timeline-item">
                                <!--begin::Label-->
                                <div class="timeline-label fw-bolder text-gray-800 fs-6">230 ₪</div>
                                <!--end::Label-->
                                <!--begin::Badge-->
                                <div class="timeline-badge">
                                    <i class="fa fa-genderless text-success fs-1"></i>
            ...
            <div class="col-xl-4">
                ...
                <div class="col-md-12 row">
                    <div class="col-xl-6">
                        ...
                        style="background-position: right top; background-size: 20% auto; background-image: url({{ '/demo1/media/svg/shapes/abstract-2.svg' }})">                            <!--begin::Body-->

                            <div class="card-body">
                                <a  href="#"
                                    class="card-title text-dark fw-bolder text-muted  text-hover-primary fs-4">الموظفين</a>
                    ...
                    <div class="col-xl-6">
                        ...
                        style="background-position: right top; background-size: 20% auto; background-image: url({{ '/demo1/media/svg/shapes/abstract-2.svg' }})">                            <!--begin::Body-->
                            ...
                            <div class="card-body">
                                <a  href="#"
                                    class="card-title text-dark fw-bolder text-muted  text-hover-primary fs-4">الطلاب</a>
                                <div class="fw-bolder text-primary fs-3qx" data-kt-countup="true"
                                    data-kt-countup-value="{{$studentsCount}}">0
                                </div>
                            </div>
                ...
                <div class="col-md-12 row">
                    <div class="col-xl-6">
                        <div class="card boxing bgi-no-repeat card-xl-stretch mb-5 mb-xl-8"
                                ...
                                <div class="card-body">
                                    <a  href="#"
                                        class="card-title text-dark fw-bolder  text-hover-primary fs-4">السائقين</a>
                    ...
                    <div class="col-xl-6">
                        <div class="card boxing bgi-no-repeat card-xl-stretch mb-5 mb-xl-8"
                                ...
                                <div class="card-body">
                                    <a  href="#"
                                        class="card-title text-dark fw-bolder  text-hover-primary fs-4">الروضات</a>
                                    <div class="fw-bolder text-dark fs-3qx" data-kt-countup="true"
                ...
                <div class="col-md-12 row">
                    <div class="col-xl-6">
                        <div class="card bgi-no-repeat card-xl-stretch mb-5 mb-xl-8"
                                ...
                                <div class="card-body">
                                    <a  href="#"
                                        class="card-title fw-bolder text-muted text-hover-primary fs-4">طلاب مسكنين</a>
                                    <div class="fw-bolder text-primary fs-3qx" data-kt-countup="true"
