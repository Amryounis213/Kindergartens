        ...
        <div class="card mb-5 mb-xl-10">
            ...
            <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
                ...
                <div class="card-title m-0">
                    <h6 class="fw-bolder m-0">تعديل الروضات</h6>
                    <span class="h-20px border-gray-200 border-start mx-4"></span>
                    <h3 class="fw-bolder m-0">{{$kindergarden->name}}</h3>
            ...
            <div id="kt_account_profile_details" class="collapse show">
                <!--begin::Form-->
                <form id="details_form" class="form" method="POST" action="{{ route('kindergarden.update' , $kindergarden->id) }}"
                    ...
                    <div class="card-body border-top p-9">
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8">
                                <input type="text" name="name"
                                       ...
                                       placeholder="اسم الروضة" value="{{$kindergarden->name}}"/>
                            </div>
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="row mb-6 fv-plugins-icon-container">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="phone" class="form-control form-control-lg form-control-solid mobile" placeholder="رقم التواصل" value="{{$kindergarden->phone}}">
